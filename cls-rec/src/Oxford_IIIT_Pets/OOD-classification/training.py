...
class PetsDataset(Dataset):
    def __init__(self, image_root, annotation_txt, transform=None):
        ...
        with open(annotation_txt, 'r') as f:
            for line in f:
                ...
                # Oxford Pets class_id는 1~37이므로 CrossEntropyLoss용으로 0~36으로 변환
...
if __name__ == '__main__':
    ...
    train_txt  = '../data/annotations/trainval.txt'
    test_txt   = '../data/annotations/test.txt'
    ...
    trainset    = PetsDataset(image_root=image_root, annotation_txt=train_txt, transform=transform)
    ...
    testset     = PetsDataset(image_root=image_root, annotation_txt=test_txt, transform=transform)
